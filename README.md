...
## 試遊会
他学科の学生をターゲットにして試遊会で遊んでもらい、意見をもらいました。
...
## こだわり
自分と同世代の、比較的ゲームに慣れている人が多いので、  
シンプルすぎず、プレイヤーによって戦略が分かれるようゲームルールを考えました。  
戦略性を求めすぎてルールが複雑で分かりにくくならないように、一つ一つの要素に対し  
必要かどうか、その要素によるリスクとリターン、逆転要素を深く考えました。  
プレイヤーが遊んでいて納得できるような見た目になるように工夫しました。
...
## 3.ルールがわかりにくい問題
学内での試遊会でアンケート(匿名)を取った結果、初めて遊ぶときに  
ルールが分かりずらいという意見がありました。

**意見1**  
エネルギーがどれくらい溜まっているのかが分かりずらかった。  
エネルギーが溜まっているのか見づらかった。
...
**意見2**  
エネルギーが満タンになったかが分かりづらい。

**問題の解決**  
バッテリー満タン時、バッテリーをセットするエリアを光らせることで、  
満タンになったかどうかを分かりやすくしました。  
バッテリーが満タンになった際に、エリアを光らせることでプレイヤーが  
次に何をすべきかを示すことができていると思います。